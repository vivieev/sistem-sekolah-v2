...
<div class="mb-8 border-b border-[#E5E3DB] pb-5">
            ...
            <p class="mt-1 text-sm text-slate-500">Memperbarui catatan kelas <span
        ...
        <form action="" method="POST" class="space-y-6 border border-[#E5E3DB] bg-white p-8">
            ...
            <div>
                <label for="grade"
                    class="mb-1.5 block text-xs font-semibold uppercase tracking-[0.1em] text-[#16213A]">Tingkat Kelas</label>
            ...
            <div>
                ...
                <select 
                    ...
                    @foreach ($majors as $major)
                        <option value="{{ $major['id'] }}"  {{ $major['id'] == old('major') ? 'selected' : '' }}>
                            {{ $major['code'] }}
                        </option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                <select 
                    id="teacher_id" name="teacher_id" class="w-full border border-[#D9D6CD] bg-[#FCFBF8] px-3.5 py-2.5 text-sm focus:border-[#A16207] focus:bg-white focus:outline-none">
